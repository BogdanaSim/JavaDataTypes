...
public class LogicalOp {
    ...
    public void displayNrOnPos(int[] array,int pos){
        try{
            System.out.println("The number on position "+pos+" from the array "+ Arrays.toString(array) +" is: "+array[pos]);
    ...
    public void wait(int number){
        try {
            ...
            System.out.println("Slept for "+number+" seconds");
        } catch (InterruptedException e) {
            System.out.println("Process sleep interrupted!");
        }
